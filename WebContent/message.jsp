...
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
 ...
 function delete_message(message){
    		if(confirm("您确定要删除该条消息吗？")){
    			location.href="${pageContext.request.contextPath }/DeleteMessageServlet?message="+message;
    		}
    	}
    </script>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-responsive">
								...
								<tr class="odd gradeX">
                                            <td  >  ${u.shopname }  </td>
                                            <td >   ${u.message } </td> 
                                            <td><button class="btn btn-danger" onclick="delete_message('${u.message}')"><i class="fa fa-pencil"></i> 删除</button></td>	
                                      </tr>
							</c:forEach>
