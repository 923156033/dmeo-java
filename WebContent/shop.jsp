...
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
    ...
    <script type="text/javascript">
    	function delete_shop(shopid){
    		if(confirm("您确定要删除该商家吗？")){
    			location.href="${pageContext.request.contextPath }/DeleteShopServlet?shopid="+shopid;
    		}
    	}
		function edit_shop(shopid,shopname,shoppassword){
 ...
 <div id="wrapper">
        ...
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><strong><i class="icon fa fa-plane"></i> 商家用户管理</strong></a>
				<div id="sideNav" href="">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <button class="btn btn-success" data-toggle="modal" data-target="#myModal1">新增商家</button>
                            <div class="table-responsive">
								...
								<tr class="odd gradeX">
                                            ...
                                            <td><button class="btn btn-primary"  data-toggle="modal" data-target="#myModal"
                                             onclick="edit_shop('${u.shopid }','${u.shopname }','${u.shoppassword }')" 
                                            ><i class="fa fa-edit "></i>编辑</button>
											<button class="btn btn-danger" onclick="delete_shop('${u.shopid }')"><i class="fa fa-pencil"></i> 删除</button></td>>
                                      </tr>
							</c:forEach>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">编辑商家信息</h4>
					</div>
					<form action="EditShopServlet">
					<div class="modal-body">
					
						<label style="width: 50px">商家id:</label><input type="text" readonly = "readonly" name="shopid" id="shopid"/>
						<label style="width: 50px">商家名:</label><input type="text" readonly = "readonly" name="shopname"id="shopname"/>
		...
		<!-- 新增弹窗 -->
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<form id="form1" action="AddShopServlet" method="post" >
					<div class="modal-body">

						<label style="width: 90px">用户名:</label><input type="text"placeholder="请输入用户名"  name="shopname"id="shopname"/>
					   <br/> <label style="width: 90px">密码:</label><input type="password"placeholder="请输入密码" name="shoppassword"  id="shoppassword"/>
					  
                             <br/> <label style="width: 90px">密保问题:</label> <select name="question" style="width:182px;height:26px">
