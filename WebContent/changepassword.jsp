...
function startRequest(){
 ...
 xmlHttp.open("POST","ChangePasswordServlet?name="+form1.username.value,true);
 xmlHttp.send(null);
 $.ajax({
		url:"${pageContext.request.contextPath }/GetQuestionServlet?name="+form1.username.value,
		dataType:"json",
		async:false,
...
<div class="container" >
    <div class="col-md-6 col-md-offset-3">
        <form action="ChangePasswordSubmit" name="form1" id="form1" method="post">
            ...
            <div class="form-group has-feedback">
              ...
              <div class="form-group has-feedback">
                <label for="mibao">密保问题</label>
                &nbsp;&nbsp;&nbsp;&nbsp;
                   <span id="question" style="color:red;"></span>
                 <div class="input-group">
                  <span class="input-group-addon"><span class="glyphicon glyphicon-lock"></span></span>
            ...
            <div class="form-group">
                <input class="form-control btn btn-primary" id="submit" value="确&nbsp;&nbsp;定&nbsp;&nbsp;更&nbsp;&nbsp;改" type="submit" >
            </div>
