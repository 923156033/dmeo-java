...
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
   ...
   <link href='https://fonts.googleapis.com/css?family=Open+Sans' rel='stylesheet' type='text/css' />
    ...
    <script type="text/javascript">
		...
		function edit_customer(customerid,customername,customerpassword,question,answer){
                            ...
                            <div class="table-responsive">
								...
								<tr class="odd gradeX">
                                            ...
                                            <td><button class="btn btn-primary"  data-toggle="modal" data-target="#myModal"
                                             onclick="edit_customer('${u.customerid }','${u.customername }','${u.customerpassword }','${u.question }','${u.answer }',)" 
         ...
         <div id="myModal" class="modal fade" tabindex="-1" role="dialog">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<form action="EditCustomerMessageServlet">
					<div class="modal-body">
					
						<br/><label style="width: 60px">id:</label><input type="text" readonly = "readonly" name="customerid" id="customerid"/>
						<br/> <label style="width: 60px">用户名:</label><input type="text" readonly = "readonly" name="customername"id="customername"/>
					    <br/><label for="password" style="width: 60px">密码:</label><input type="password" name="customerpassword"  id="customerpassword"/>

					     <br/><label style="width: 60px">密保题:</label><input type="text" readonly = "readonly" name="question"id="question"/>
					   <br/> <label style="width: 60px">答案:</label><input type="text"  name="answer"id="answer"/>
