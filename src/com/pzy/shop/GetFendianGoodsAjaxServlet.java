...
/**
 * Servlet implementation class GetFendianGoodsAjaxServlet
 */
@WebServlet("/GetFendianGoodsAjaxServlet")
public class GetFendianGoodsAjaxServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetFendianGoodsAjaxServlet() {
        super();
        ...
        try {
			Class.forName("com.mysql.jdbc.Driver").newInstance();
			 Connection connection = (Connection) DriverManager.getConnection(url);  
		        ...
		        String sql = "SELECT * FROM goods where shopid='"+fendianid+"'";  
		        ...
		        Gson gson = new Gson();
		        String goodList_json = gson.toJson(GoodsList);
