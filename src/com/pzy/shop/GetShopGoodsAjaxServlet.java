...
/**
 * Servlet implementation class GetShopGoodsAjaxServlet
 */
@WebServlet("/GetShopGoodsAjaxServlet")
public class GetShopGoodsAjaxServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetShopGoodsAjaxServlet() {
        super();
