...
/**
 * Servlet implementation class GetShopRequestServlet
 */
@WebServlet("/GetShopRequestServlet")
public class GetShopRequestServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetShopRequestServlet() {
        super();
        ...
        try {
			Class.forName("com.mysql.jdbc.Driver").newInstance();
			 Connection connection = (Connection) DriverManager.getConnection(url);  
		        ...
		        String sql = "SELECT * FROM request where shopid='"+shopid+"' and state='请求审核中'";  
		        ...
		        request.getRequestDispatcher("shoprequest.jsp").forward(request, response);
		        rs.close();  
		        statement.close();  
		        connection.close();  
		} catch (Exception e) {
